        ...
        <div class="dialog-add">
            <div class="dialog-add-container">
                <div class="dialog-left">
                    ...
                    <div class="dialog-employee-name"><input class="binding-name" type="text"
                            v-model="newEmployee.EmployeeName" disabled></div>
                    <div class="dialog-employee-code"><input class="binding-code" type="text"
                            v-model="newEmployee.EmployeeCode" disabled></div>
                ...
                <div class="dialog-right">
                    ...
                    <div class="dialog-right-body">
                        ...
                        <input v-model="newEmployee.Email" class="dialog-el-7 dialog-input text-input" type="text"
                            id="txtEmployeeEmail" placeholder="annv@gmail.com">
...
export default {
    ...
    created() {
        ...
        this.newEmployee.DepartmentId = "142cb08f-7c31-21fa-8e90-67245e8b283e";
    },
